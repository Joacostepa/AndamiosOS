...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: sin esto el inset no puede achicarse por debajo del ancho de su
        // contenido y empuja la pagina mas alla del viewport, con un scroll horizontal
        // externo del ancho del riel del sidebar. El contenido ancho —el tablero— maneja
        // su propio scroll adentro.
